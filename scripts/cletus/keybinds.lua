...
local function MUJDML_fake_script() -- christmas.LocalScript 
...
coroutine.wrap(MUJDML_fake_script)()
local function MSNDFKT_fake_script() -- level1.LocalScript 
...
coroutine.wrap(MSNDFKT_fake_script)()
local function KASS_fake_script() -- level2.LocalScript 
...
coroutine.wrap(KASS_fake_script)()
local function GXBA_fake_script() -- melon.LocalScript 
...
coroutine.wrap(GXBA_fake_script)()
local function DYPK_fake_script() -- pineapples.LocalScript 
...
coroutine.wrap(DYPK_fake_script)()
local function XXWPN_fake_script() -- pumpkin.LocalScript 
...
coroutine.wrap(XXWPN_fake_script)()
local function SZBZSYJ_fake_script() -- frame.draggable 
...
coroutine.wrap(SZBZSYJ_fake_script)()
local function XPUZV_fake_script() -- frame.keybind 
	local script = Instance.new('LocalScript', frame)
...
coroutine.wrap(XPUZV_fake_script)()
